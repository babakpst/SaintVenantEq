...
#        print()                       
    ...
    def get_alpha_epsilon(self, Hhat, EF, AFhat, AF, EtaF, QFhatS,
        ...
        # limite the correction to prevent sign change
...
#=============================================================================
    def solve(self):
        ...
        Plot2 = 1# Plots the full results at the cell center, every "Plot2" steps.
